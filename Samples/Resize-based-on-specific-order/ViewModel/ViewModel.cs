...
namespace RibbonSample
{
    ...
    class ViewModel : NotificationObject
    {
        ...
        /// <summary>
        /// Maintains the command for right to left.
        /// </summary>
        private ICommand rightToLeftCommand;
        ...
        /// <summary>
        /// Maintains the command for displaying modal tab item.
        /// </summary>
        private ICommand showModalTabCommand;

        /// <summary>
        /// Maintains the command for closing modal tab item.
        /// </summary>
        private ICommand closeModalTabCommand;
        ...
        /// <summary>
        /// Maintains the boolean for isEnable property of drop split bar.
        /// </summary>
        private bool dropSplitButtonsBarIsEnableProperty;

        /// <summary>
        /// Maintains the window flow direction.
        /// </summary>
        private FlowDirection windowFlowDirectionProperty;
        ...
        public ViewModel()
        {
            ...
            dropSplitButtonsBarIsEnableProperty = true;
            showModalTabCommand = new DelegateCommand<object>(ExecuteShowModalTabCommand);
            closeModalTabCommand = new DelegateCommand<object>(ExecuteCloseModalTabCommand);
            ...
            rightToLeftCommand = new DelegateCommand<object>(ExecuteRightToLeftCommand);
        ...
        public FlowDirection WindowFlowDirectionProperty { get { return windowFlowDirectionProperty; } set { windowFlowDirectionProperty = value; RaisePropertyChanged("WindowFlowDirectionProperty"); } }
        /// <summary>
        ...
        /// <summary>
        /// Indicates whether the drop split buttons bar isenable property is true or false <see cref="ViewModel"/>class.
        /// </summary>
        public bool DropSplitButtonsBarIsEnableProperty { get { return dropSplitButtonsBarIsEnableProperty; } set { dropSplitButtonsBarIsEnableProperty = value; RaisePropertyChanged("DropSplitButtonsBarIsEnableProperty"); } }
        ...
        /// <summary>
        /// Gets or sets the ribbon gallery item is selected or not <see cref="ViewModel"/> class.
        /// </summary>
        ...
        public static void OnRichTextBoxChanged(DependencyObject obj, DependencyPropertyChangedEventArgs args)
        {
            ...
            LoadTextDocument(Environment.CurrentDirectory + "\\Resources\\TextContent.txt");
        }

        /// <summary>
        /// Gets or sets the command for right to left button <see cref="ViewModel"/> class.
        /// </summary>
        public ICommand RightToLeftCommand { get { return rightToLeftCommand; } }
        ...
        /// <summary>
        /// Gets or sets the command for displaying Modal tab <see cref="ViewModel"/> class.
        /// </summary>
        public ICommand ShowModalTabCommand { get { return showModalTabCommand; } }

        /// <summary>
        /// Gets or sets the command for closing Modal tab <see cref="ViewModel"/> class.
        /// </summary>
        public ICommand CloseModalTabCommand { get { return closeModalTabCommand; } }
        ...
        private void ExecuteSaveAsCommand(object parameter)
        {
            ...
            if (saveFile.ShowDialog().Value)
            {
                ...
                t.Save(rtfFile, System.Windows.DataFormats.Text);
                rtfFile.Close();
            }
        }
        ...
        private void ExecuteOpenCommand(object parameter)
        {
            ...
            {
                LoadTextDocument(openFile.FileName);
                ribbon.HideBackStage();
            }
        }

        /// <summary>
        /// Loads the text document in the rich text box.
        /// </summary>
        /// <param name="fileName">Name of the file that needs to be loaded</param>
        private static void LoadTextDocument(string fileName)
        {
            TextRange range;
            System.IO.FileStream fStream;
            if (System.IO.File.Exists(fileName) && richTextBox != null)
            {
        ...
        /// <summary>
        /// Method used to execute right to left command. 
        /// </summary>
        /// <param name="parameter">Specifies the object type parameter.</param>
        private void ExecuteRightToLeftCommand(object parameter)
        {
            WindowFlowDirectionProperty = (FlowDirection)(1 - (int)WindowFlowDirectionProperty);
        }
        ...
        private void ExecuteRibbonDisableCommand(object parameter)
        {
            ...
            DropSplitButtonsBarIsEnableProperty = !DropSplitButtonsBarIsEnableProperty;
        }

        /// <summary>
        /// Method used to execute ShowModalTabCommand. 
        /// </summary>
        /// <param name="parameter">Specifies the object type parameter.</param>
        private void ExecuteShowModalTabCommand(object parameter)
        {
            if(ribbon != null)
            {
                ribbon.ShowModalTab("mailings");
            }
        }

        /// <summary>
        /// Method used to execute CloseModalTabCommand. 
        /// </summary>
        /// <param name="parameter">Specifies the object type parameter.</param>
        private void ExecuteCloseModalTabCommand(object parameter)
        {
            if (ribbon != null)
            {
        ...
        {
            if (parameter != null && parameter is Model)
            {
                if ((parameter as Model).FontFamily != null)
                    richTextBox.FontFamily = new FontFamily((parameter as Model).FontFamily);
                if ((parameter as Model).FontSize > 0)
                    richTextBox.FontSize = (parameter as Model).FontSize;
            }
        }
        #endregion
    }
